...
// devkit8000 LEDs
#define GPIO6_OE *((volatile unsigned int *)0x49058034)
#define GPIO6_DATAOUT *((volatile unsigned int *)0x4905803C)
#define GPIO6_SETDATAOUT *((volatile unsigned int *)0x49058094)
#define GPIO6_CLEARDATAOUT *((volatile unsigned int *)0x49058090)
